...
import CodebaseModifier from "@/components/codebase-modifier"
import { Github, Code, Key } from "lucide-react"
import { Input } from "@/components/ui/input"
import { Button } from "@/components/ui/button"
import { useToast } from "../../hooks/use-toast"

export default function CodebaseModifierPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold mb-8 text-center">Codegen Codebase Modifier</h1>
